...
export default function InnenausbauHero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden -mt-20">
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage: `url('/images/innenausbau-hero-bg.jpg')`,
        }}
      >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-left w-full">
        <div className="max-w-3xl">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed px-2">
            Professioneller Innenausbau für Wohn- und Geschäftsräume. Von der Raumaufteilung bis zur finalen Gestaltung – Ihr Spezialist für hochwertigen Innenausbau in München, Schwabing, Maxvorstadt und dem gesamten Münchner Umland.
          </p>
