      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-left w-full pt-20">
        <div className="max-w-3xl">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-6 leading-tight px-2">
            Unsere
            <span className="block text-[#C04020]">Leistungen</span>
            in München
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed px-2">
            Umfassende Bau- und Renovierungsdienstleistungen mit Münchner Meisterqualität. Von der Planung bis zur Fertigstellung – alles aus einer Hand für München und Umgebung.
          </p>
