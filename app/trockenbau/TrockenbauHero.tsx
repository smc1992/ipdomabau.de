...
export default function TrockenbauHero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden -mt-20">
      <div 
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage: `url('/images/trockenbau-hero.jpg')`
        }}
      >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-left w-full">
        <div className="max-w-3xl">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-6 leading-tight px-2">
            Professioneller
            <span className="block text-[#C04020]">Trockenbau</span>
            in München
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed px-2">
            Moderne Trockenbaulösungen für Raumaufteilung, Schallschutz und Wärmedämmung. Schnell, sauber und präzise ausgeführt von unserem Meisterbetrieb in München und Umgebung.
          </p>
